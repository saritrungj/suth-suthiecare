      ...
      <header className="hc-user-hero">
        <div className="hc-user-container">
          ...
          >
            ...
            <div
              className={`hc-user-search-wrapper ${showSuggestions && searchResults.length > 0 ? "has-suggestions" : ""}`}
            >
            ...
            {showSuggestions && (
              <div className="hc-search-suggestions-dropdown">
                {searchResults.length > 0 ? (
                  searchResults.map((faq) => (
                    ...
                    >
                      <div className="hc-suggestion-info">
                        <small className="hc-suggestion-clinic-tag">
                          {faq.clinic_name || "ศูนย์ทั่วไป"}
                        </small>
                  ...
                  <div className="hc-suggestion-empty">
                    ไม่พบข้อคำถามที่ตรงกับ "{searchQuery}"
                  </div>
                )}
              </div>
            )}
            ...
            <section className="hc-user-section">
              <div className="hc-section-header-row">
                <div className="hc-section-header">
                  ...
                  <div className="hc-section-header-text">
                    ...
                    <p>
                      เลือกคลินิกที่คุณต้องการข้อมูลช่วยเหลือ
              ...
              {isAllClinicsExpanded ? (
                ...
                <div className="hc-slider-wrapper">
                  ...
                  <button
                    className="hc-slider-arrow arrow-right"
